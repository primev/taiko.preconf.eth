...
This repository contains the implementation for integrating mev-commit preconfirmations with Taiko. The goal is to enable Taiko users to receive instant preconfirmations committed by L1 execution service providers.
